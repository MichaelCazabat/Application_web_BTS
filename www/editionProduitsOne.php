<?php
   ...
   log_only();
   $getid_utilisateur = $_GET['74TY89jyArbfgk'];

   $id_produits = base64_decode($_GET['grfcvx45ht7J']);
   ...
   if(isset($id_produits)) {
      ...
      if(isset($_POST['newreference']) AND !empty($_POST['newreference']) AND $_POST['newreference'] != $user['reference']) {
         ...
         header('Location: onlyOneMag.php?Qazty120hyu='.$getid_utilisateur);
      }
...
<body>
   <div align="center">
      ...
      <a href="onlyOneMag.php?Qazty120hyu=<?php echo $getid_utilisateur?>"><input type="button" value="Retour" class="taille"></a>
